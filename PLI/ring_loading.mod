...
/*
  ...
  * E' nota, in base a rilevamenti eseguiti in precedenza, la dimensione massima del traffico (quantità di dati per unità di tempo) 
  * che si prevede ogni calcolatore trasmetterà ad ogni altro. 
